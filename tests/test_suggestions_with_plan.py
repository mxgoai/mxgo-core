...
def test_suggestions_with_plan(email: str, plan_type: str):
    """Test the /suggestions API endpoint with a specific user."""
...
def main():
    ...
    # Test PRO user
    test_suggestions_with_plan("satwikkansal@gmail.com", "PRO")

    # Test BETA user
    test_suggestions_with_plan("test@example.com", "BETA")
