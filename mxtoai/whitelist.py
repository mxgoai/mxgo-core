...
async def send_verification_email(email: str, verification_token: str) -> bool:
    ...
    try:
        ...
        subject = "Verify your email for MXtoAI"

        text_content = f"""Welcome to MXtoAI!
...
---
MXtoAI - Transform your emails with AI
https://mxtoai.com"""
...
<head>
    <meta charset="utf-8">
    <title>Verify your email - MXtoAI</title>
    <style>
...
<body>
    <div class="container">
        <div class="header">
            <h1 style="margin: 0; font-size: 28px;">Welcome to MXtoAI!</h1>
        </div>
        <div class="content">
            ...
            <p>Best regards,<br>
            <strong>MXtoAI Team</strong></p>
        </div>
        <div class="footer">
            <p><strong>MXtoAI</strong> - Transform your emails with AI</p>
            <p><a href="https://mxtoai.com" style="color: #667eea;">https://mxtoai.com</a></p>
        </div>
    </div>
</body>
</html>"""
...
def get_whitelist_signup_url() -> str:
    ...
    """
    return os.getenv("WHITELIST_SIGNUP_URL", "https://mxtoai.com/whitelist")
