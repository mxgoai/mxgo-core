...
def upgrade() -> None:
    ...
    sa.Column("status", sa.Enum("INITIALISED", "ACTIVE", "EXECUTING", "FINISHED", "DELETED", name="taskstatus"), nullable=False),
    ...
    sa.Column("task_id", sa.Uuid(), nullable=False),
    sa.Column("status", sa.Enum("INITIALISED", "IN_PROGRESS", "COMPLETED", "ERRORED", name="taskrunstatus"), nullable=False),
